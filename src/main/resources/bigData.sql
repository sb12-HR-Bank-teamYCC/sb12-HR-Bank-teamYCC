...
SELECT gen_random_uuid() AS file_id, s.i AS rn
...
SELECT
    ...
    '2023-01-01'::timestamp
        + floor(random() * 1216)::int * INTERVAL '1 day'
...
-- ────────────────────────────────────────────────────────────
-- 6. employees 10,000건
--    hire_date / created_at / updated_at: 2023-01-01 ~ 2026-04-30
...
SELECT
    ...
    '2023-01-01'::date + floor(random() * 1216)::int,
    (ARRAY['ACTIVE','ON_LEAVE','RESIGNED'])[ ((te.rn - 1) % 3) + 1 ],
    '2023-01-01'::timestamp + floor(random() * 1216)::int * INTERVAL '1 day',
    '2023-01-01'::timestamp + floor(random() * 1216)::int * INTERVAL '1 day' + INTERVAL '2 hours',
...
--     at: 2023-01-01 ~ 2026-04-30 랜덤 분포
-- ────────────────────────────────────────────────────────────
